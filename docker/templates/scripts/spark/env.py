...
class SparkEnv:
    ...
    spark_version: str = os.environ.get('SPARK_VERSION', '3.5.3')
    hadoop_version: str = os.environ.get('HADOOP_VERSION', '3.3.2')
    scala_version: str = os.environ.get('SCALA_VERSION', '2.12')
